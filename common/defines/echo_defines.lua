...
NDefines.NDiplomacy.FORCE_BREAK_ALLIANCE_TRUCE_YEARS = 5
...
NDefines.NDiplomacy.PEACE_COST_DEMAND_PROVINCE = 0.8					-- Demand a province (scales by province wealth, also used for annex)
NDefines.NDiplomacy.PEACE_COST_CONCEDE_PROVINCE = 20			-- Demand colonial area province concession.
...
NDefines.NCountry.ABDICATE_AGE_THRESHOLD = 25
...
NDefines.NCountry.REGULAR_COLONY_GROWTH = 50
...
NDefines.NCountry.ESTATE_MIN_DISTRIBUTED_CROWNLAND = 30
...
NDefines.NCountry.NATIVE_UPRISING_CHANCE_PER_AGGRESSIVENESS = 0
...
NDefines.NMilitary.CREATE_JANISSARIES_MIL_COST = 3			-- Cost to create janissaries (per unit)
NDefines.NMilitary.CREATE_CAWA_MIL_COST = 3					-- Cost to create Cawa (per unit)
...
NDefines.NAI.PEACE_ALLY_WARGOAL_MULT = 1 -- Multiplies PEACE_WARGOAL_FACTOR for allies in a war
...
NDefines.NGovernment.GOVERNMENT_REFORM_CHANGE_PROGRESS_COST = 30
...
NDefines.NGame.DAYS_BEHIND_LOWER_SPEED = 45		-- In multiplayer, if the slowest player is lagging behind this amount of days, the game will slow down