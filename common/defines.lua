...
NDiplomacy = {
	...
	INTEGRATE_UNION_MIN_YEARS = 25,					-- Number of years before a union can be integrated
	INTEGRATE_VASSAL_MIN_YEARS = 5,				-- Number of years before a vassal can be integrated

	MONTHS_BEFORE_TOTAL_OCCUPATION = 3,			-- Before this many months have passed in the war, you cannot gain 100% warscore by just occupying the warleader
...
NMilitary = {
	...
	INFANTRY_TIME = 50, 							-- _MDEF_INFANTRY_TIME = 10,
	CAVALRY_TIME = 70, 								-- _MDEF_CAVALRY_TIME = 10,
	ARTILLERY_TIME = 100, 							-- _MDEF_ARTILLERY_TIME = 10,
	HEAVY_SHIP_TIME = 600, 							-- _MDEF_HEAVY_SHIP_TIME = 10,
	LIGHT_SHIP_TIME = 300, 							-- _MDEF_LIGHT_SHIP_TIME = 10,
	GALLEY_TIME = 300, 								-- _MDEF_GALLEY_TIME = 10,
	TRANSPORT_TIME = 100, 							-- _MDEF_TRANSPORT_TIME = 10,
	...
	MERCENARY_REINFORCE_COST_MULTIPLIER = -1.5,			-- Mercs no longer costs anything to reinfroce
	MERCENARY_BASE_COST = 30.0,					-- base cost added for a mercenary regiment
	...
	CREATE_HUSSARS_MIL_COST = 2;					-- Cost to create Hussars (per unit)
